...
export async function initOverview() {
  ...
  const cards = [
    ...
    },
    {
      ...
      color: "#26D0CE",
      meta1: "Detection Pipeline",
      footerRightLabel: "Scanned",
    ...
    },
    {
      ...
      color: "#4A90E2",
      meta1: "Critical Queue",
      footerRightLabel: "Flagged",
    ...
    },
    {
      ...
      color: "#FF9F43",
      meta1: "Live Monitoring",
      meta2: kpis.activeCameras ? "6 Online" : "Offline",
      footerRightLabel: "Active",
    ...
    },
    {
      ...
      color: "#A78BFA",
      meta1: "Enforcement Desk",
      footerRightLabel: "Issued",
  ...
  kpiGrid.innerHTML = cards.map((c) => kpiCard({
    ...
    meta1: c.meta1,
    meta2: c.meta2,
    footerLeftLabel: c.footerLeftLabel || "Trend",
    footerRightLabel: c.footerRightLabel || "Total",
    trend: c.trend,
